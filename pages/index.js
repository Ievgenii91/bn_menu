      ...
      <main className={styles.main}>
        ...
        <div className={styles.side}>
          ...
          <div className={styles.punchBlock}>          
            <h3 className={styles.punch}>пунш.</h3>
            <p className={styles.product}>
              ПУНШ (гарячий і алкогольний)
              <span className={styles.price}>
                <b>39₴</b>
              </span>            
            </p>
            <p className={styles.product}>
              ПУНШ з наливкою <span className={styles.attention}>(РЕКОМЕНДУЄМО!)</span>
              <span className={styles.price}>
                <b>69₴</b>
              </span>
            </p>            
